...
predictions_path = os.path.join(data_path, 'taxi_lr_opt_removal_predictions', disk_fname)
removals_path = os.path.join(data_path, 'taxi_lr_opt_removals', disk_fname)
