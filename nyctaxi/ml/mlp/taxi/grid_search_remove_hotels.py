...
predictions_path = os.path.join(data_path, 'grid_search_taxi_remove_hotels_mlp_predictions', fname)
removals_path = os.path.join(data_path, 'grid_search_taxi_mlp_removals', fname)
