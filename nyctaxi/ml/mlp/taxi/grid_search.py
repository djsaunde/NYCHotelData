...
print('Grid-searching over multi-layer perceptron regression models.')
...
print('Grid search complete. Running multiple train / test iterations with best hyper-parameters.')
