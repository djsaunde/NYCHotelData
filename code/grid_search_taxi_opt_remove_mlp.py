...
predictions_path = os.path.join('..', 'data', 'grid_search_taxi_opt_remove_mlp_predictions', fname)
removals_path = os.path.join('..', 'data', 'grid_search_taxi_mlp_opt_removals', fname)
