...
predictions_path = os.path.join(data_path, 'grid_search_taxi_opt_remove_mlp_predictions', disk_fname)
removals_path = os.path.join(data_path, 'grid_search_taxi_mlp_opt_removals', disk_fname)
